...
runner = [
    ...
    {"h": 104.0, "pt": 144009935, "rank": 134, "note": "8/22 04:00。夜間ブロック（19:00〜28:00）終了時。総合Pt・総合順位とも本人申告（ゲーム内表示）。この値から ch2 最終が 56,370,970 と確定（総合 − ch1 62,207,685 − ch3 25,431,280）。夜間はランキング板の3分ポーリング×ラップ計測で全周を実測: 在室2時間はちょうど60周・途切れ実質ゼロ、平均単価 107,95x〜107,99x/周でモデル（107,975）のど真ん中"},
]
